...
/******** Clustered netlist to be mapped stuff ********/
    ...
    clb_to_vpack_net_mapping = NULL; /* [0..num_clb_nets - 1] */
   vpack_to_clb_net_mapping = NULL; /* [0..num_vpack_nets - 1] */

/* This identifies the t_type_ptr of an IO block */
    num_types = 0;
    type_descriptors = NULL;
 ...
 * count.                                                                    */
    ...
    grid = NULL; /* [0..(nx+1)][0..(ny+1)] Physical block list */

/******** Structures defining the routing ********/

/* Linked list start pointers.  Define the routing. */
    trace_head = NULL; /* [0..(num_nets-1)] */
    trace_tail = NULL; /* [0..(num_nets-1)] */

/******** Structures defining the FPGA routing architecture ********/

    num_rr_nodes = 0;
    rr_node = NULL; /* [0..(num_rr_nodes-1)] */
...
//num_rr_node和rr_node备份
    ...
    num_rr_indexed_data = 0;
    rr_indexed_data = NULL; /* [0..(num_rr_indexed_data-1)] */

/* Gives the rr_node indices of net terminals. */

    net_rr_terminals = NULL; /* [0..num_nets-1][0..num_pins-1] */

/* Gives information about all the switch types                      *
 * (part of routing architecture, but loaded in read_arch.c          */

    g_num_arch_switches = 0;
    g_arch_switch_inf = NULL; /* [0..(g_num_arch_switches-1)] */
    g_num_rr_switches = 0;
    g_rr_switch_inf = NULL; /* autogenerated in build_rr_graph based on switch fan-in. [0..(g_num_rr_switches-1)] */
    g_switch_fanin_remap = NULL; /* an array of map. array index: [0..(g_num_arch_switches-1)]; map key: # of fanin; map value: remapped switch index */
...
/* Stores the SOURCE and SINK nodes of all CLBs (not valid for pads).     */
    ...
    rr_blk_source = NULL; /* [0..(num_blocks-1)][0..(num_class-1)] */

/* primiary inputs removed from circuit */
    circuit_p_io_removed = NULL;

/********** Structures representing timing graph information */
    pb_max_internal_delay = UNDEFINED; /* biggest internal delay of physical block */
    pbtype_max_internal_delay = NULL; /* physical block type with highest internal delay */
